...
-   Better Auth internal messages and HackKit domain messages share one pipeline when the plugin logger bridge is used; apps that need separation can configure the Better Auth logger and HackKit plugin logger independently.
